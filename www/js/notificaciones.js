var app = { 
    ...
    checkRelativeRoot: function(){
        ...
        if((rutaRelativa == "index.html") || (rutaRelativa == "login.html")){
            ...
            numero = 2;
        }else if(rutaRelativa == "suscriptores2.html" || rutaRelativa == "suscriptores3.html" || rutaRelativa == "suscriptores4.html" || rutaRelativa == "suscriptores5.html" || rutaRelativa == "cuadroDialogoDireccion.html" || rutaRelativa == "cuadroDialogoContrato.html" || rutaRelativa == 'waiting_room.html'){
            numero = 10; 
