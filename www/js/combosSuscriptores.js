...
-- ======================================================================
-- Author:      <DIEGO, ACOSTA>
-- Create date: <13 DE JULIO DE 2015>
-- Description: <CALCULA RANGO DE AÑOS TOMANDO EN CUENTA MAYORÍA DE EDAD>
-- ======================================================================
ALTER PROCEDURE [dbo].[USP_ACOSTA_GET_YEARS] 
...
BEGIN
    ...
    DECLARE 
        @LS_CURRENT_YEAR nvarchar(15),
        @LN_MIN_YEAR int

    --TABLA TEMPORAL PARA ALMACENAR LOS AÑOS QUE SE GENERAN--
    DECLARE
        @TEMP_YEARS TABLE(YEARS INT)
    ...
    --GENERAMOS EL RANGO DE AÑOS POSIBLES Y LOS ASIGNAMOS A LA TABLA TEMPORAL @TEMP_YEARS PARA SU CONSULTA--
    WHILE(@LN_MIN_YEAR >= 1931)
        BEGIN
    
            SET @LN_MIN_YEAR = @LN_MIN_YEAR - 1;

            INSERT INTO @TEMP_YEARS(YEARS)
            SELECT @LN_MIN_YEAR

        END

    --SELECCIONAMOS TODOS LOS AÑOS GENERADOS DE LA TABLA TEMPORAL--
